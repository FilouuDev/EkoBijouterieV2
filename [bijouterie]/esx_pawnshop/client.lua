...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(gym) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Appuyer Sur ~INPUT_CONTEXT~ Pour Vendre')
...
function OpenSellMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'pawn_sell_menu',
        {
            ...
            elements = {
                {label = 'Bijoux', value = 'saffron'},
                {label = 'Diamant', value = 'speaker'},
                {label = 'Bague', value = 'laptop'},
                {label = '', value = 'book'},
                {label = '', value = 'coupon'},
                {label = '', value = 'toothpaste'},
                {label = '', value = 'lotteryticket'},
                {label = '', value = 'shirt'},
                {label = '', value = 'pants'},
            }
        },
