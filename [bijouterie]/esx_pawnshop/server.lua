...
AddEventHandler('esx_pawnshop:sellsaffron', function()
    ...
    if saffron > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'Oh tu na plus de bijoux')
    end
end)
...
AddEventHandler('esx_pawnshop:sellspeaker', function()
    ...
    if speaker > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'Oh tu na plus de diamant')
    end
end)
...
AddEventHandler('esx_pawnshop:selllaptop', function()
	...
	for i=1, #xPlayer.inventory, 1 do
		...
		if item.name == "bague" then
			laptop = item.count
		end
	end
    
    if laptop > 0 then
        xPlayer.removeInventoryItem('bague', 1)
        xPlayer.addMoney(150)
    else 
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'Oh tu na plus de bagues')
    end
end)
