...
AddEventHandler('esx_vangelico_robbery:gioielli', function()
	...
	xPlayer.addInventoryItem('bague', math.random(Config.MinJewels, Config.MaxJewels))
end)
...
AddEventHandler('esx_vangelico_robbery:gioielli', function()
	...
	xPlayer.addInventoryItem('diamant', math.random(Config.MinJewels, Config.MaxJewels))
end)
